...
public:
	...
	//! @param[out] hit_point     衝突点
	//! @param[in]  line_segment0 線分
	//! @param[in]  line_segment1 線分
	...
	//----------------------------------------
	//! @brief 平面と平面の衝突判定関数
	//! @param[out] hit_line_segment 衝突線分
	//! @param[in]  plane0           平面
	//! @param[in]  plane1           平面
	//! @retval bool 衝突している場合true
	//----------------------------------------
	...
	//! @param[in]  capsule1      カプセル
	//! @param[in]  active_vector 補正用ベクトル
	//! @retval bool 衝突している場合true
	//----------------------------------------
...
private:
	...
	//! @param[in] triangle0          三角形平面
	//! @param[in] triangle1          三角形平面
	//! @param[in] is_hit_segment_one 1辺が貫通しているかフラグ
	...
	//! @param[in] segment_vector 線分ベクトル
	//! @param[in] plane          平面
	//! @param[in] length         長さ
	...
	//! @param[in] other_separation_axis1 相手の分離軸
	...
	//! @param[in] my_separation_axis1       自分の分離軸
	//! @param[in] other_separation_axis0    相手の分離軸
	//! @param[in] other_separation_axis1    相手の分離軸
	//! @param[in] interval_vector           両方のOBB間のベクトル
	//! @retval bool 衝突している場合true
